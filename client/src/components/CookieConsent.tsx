...
export default function CookieConsent() {
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 z-50 p-4 transition-all duration-300 ${
      ...
      <div className="bg-black/20 backdrop-blur-sm absolute inset-0" onClick={handleClose}></div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Choose which cookies you'd like to enable</p>
                  </div>
                </div>
                <Button
                  variant="ghost"
                ...
                <div className="flex items-center justify-between p-4 bg-green-50 rounded-xl border border-green-200">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-green-600 mt-1 font-medium">Always active for security</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 border rounded-xl hover:bg-gray-50 transition-colors">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">Help us understand how visitors use our website</p>
                      <p className="text-xs text-blue-600 mt-1 font-medium">Improves user experience</p>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-4 border rounded-xl hover:bg-gray-50 transition-colors">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">Remember your preferences and provide enhanced features</p>
                      <p className="text-xs text-purple-600 mt-1 font-medium">Personalizes your experience</p>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-4 border rounded-xl hover:bg-gray-50 transition-colors">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">Used to deliver relevant advertisements and content</p>
                      <p className="text-xs text-orange-600 mt-1 font-medium">Shows relevant content</p>
                    </div>
                  </div>
                  <Switch
