    ...
    <section id="contact" className="py-20 bg-light-gray">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Get a free consultation and customized quote</p>
        </div>
        
        <div className="grid lg:grid-cols-2 gap-12">
          <div>
            <h3 className="font-poppins font-bold text-2xl text-primary-blue mb-6">Get In Touch</h3>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                <Select onValueChange={(value) => form.setValue("service", value)}>
                  ...
                  <SelectContent>
                    <SelectItem value="generator-maintenance">Generator Parts & Maintenance</SelectItem>
                    <SelectItem value="solar-inverter">Custom Solar & Inverter Systems</SelectItem>
                    <SelectItem value="energy-audit">Energy Audit & Consultancy</SelectItem>
                    <SelectItem value="iot-monitoring">IoT Monitoring & Management</SelectItem>
                  </SelectContent>
                </Select>
              </div>
