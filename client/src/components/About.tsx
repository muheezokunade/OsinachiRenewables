        ...
        <div className='grid lg:grid-cols-2 gap-12 items-center'>
          ...
          <div>
            ...
            <p className='text-lg text-gray-700 mb-6'>
              ...
              specialists servicing traditional generators—Perkins, Caterpillar,
              Cummins, and Lister—learning firsthand the frustrations businesses
              face with unreliable power.
            </p>
