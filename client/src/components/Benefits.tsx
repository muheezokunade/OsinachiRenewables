    ...
    <section className="py-20 bg-primary-blue text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="font-poppins font-bold text-4xl mb-4">Why Choose Osinachi?</h2>
          <p className="text-xl text-gray-200">We fix the power struggles others couldn't fix.</p>
        </div>
