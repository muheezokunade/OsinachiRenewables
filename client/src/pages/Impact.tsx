...
const Impact: React.FC = () => {
  ...
  const systemSizes = [
    {
      value: '3',
      label: '3 kW (Small Home)',
      annualGeneration: 4380,
      cost: 1500000,
    },
    {
      value: '5',
      label: '5 kW (Medium Home)',
      annualGeneration: 7300,
      cost: 2500000,
    },
    {
      value: '10',
      label: '10 kW (Large Home)',
      annualGeneration: 14600,
      cost: 4500000,
    },
    {
      value: '20',
      label: '20 kW (Small Business)',
      annualGeneration: 29200,
      cost: 8500000,
    },
    {
      value: '50',
      label: '50 kW (Medium Business)',
      annualGeneration: 73000,
      cost: 20000000,
    },
  ];
  ...
  const calculateImpact = () => {
    ...
    const systemSize = systemSizes.find(
      size => size.value === calculatorData.systemSize
    );
  ...
  const socialImpact = [
    {
      ...
      description:
        'Bringing reliable electricity to underserved rural communities across Nigeria',
    ...
    },
    {
      title: 'Job Creation',
      description:
        'Creating employment opportunities in the renewable energy sector',
    ...
    },
    {
      ...
      description:
        'Training local technicians and engineers in solar technology',
  ...
  const caseStudies = [
    {
      ...
      challenge:
        'High energy costs and unreliable power supply affecting production',
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600'>
              Our commitment to reducing carbon emissions and promoting clean
              energy
            </p>
          </div>
      ...
      <section className='py-20 bg-light-gray'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600'>
              Creating positive change in communities across Nigeria
            </p>
          </div>
      ...
      <section className='py-20 bg-white'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600'>
              Real-world examples of our impact on businesses and communities
            </p>
          </div>
      ...
      <section className='py-20 bg-light-gray'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600'>
              Our roadmap to creating a sustainable future
            </p>
          </div>
      ...
      <section className='py-20 bg-white'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600'>
              See how switching to solar can reduce your carbon footprint
            </p>
          </div>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='flex gap-2'>
                    <Button
                      ...
                      disabled={
                        !calculatorData.monthlyBill ||
                        !calculatorData.systemSize
                      }
                    >
                      Calculate Impact
                    </Button>
                    ...
                    <div className='flex justify-between'>
                      ...
                      <span className='font-semibold text-green-600'>
                        {calculatorResults.isCalculated
                          ? `${calculatorResults.co2Reduction} tons/year`
                          : '-- tons/year'}
                      </span>
                    </div>
                    <div className='flex justify-between'>
                      ...
                      <span className='font-semibold text-green-600'>
                        {calculatorResults.isCalculated
                          ? `${calculatorResults.energySavings.toLocaleString()} kWh/year`
                          : '-- kWh/year'}
                      </span>
                    </div>
                    <div className='flex justify-between'>
                      ...
                      <span className='font-semibold text-green-600'>
                        {calculatorResults.isCalculated
                          ? `₦${calculatorResults.annualSavings.toLocaleString()}/year`
                          : '₦--/year'}
                      </span>
                    </div>
                    <div className='flex justify-between'>
                      ...
                      <span className='font-semibold text-green-600'>
                        {calculatorResults.isCalculated
                          ? `${calculatorResults.treesEquivalent} trees`
                          : '-- trees'}
                      </span>
                    </div>
                    <div className='flex justify-between'>
                      ...
                      <span className='font-semibold text-green-600'>
                        {calculatorResults.isCalculated
                          ? `${calculatorResults.paybackPeriod} years`
                          : '-- years'}
                      </span>
                    </div>
                  </div>
                  {calculatorResults.isCalculated && (
                    <div className='mt-4 p-3 bg-green-100 rounded-md'>
                      <p className='text-sm text-green-800'>
                        💡 <strong>Tip:</strong> These calculations are
                        estimates based on average Nigerian conditions. Contact
                        us for a detailed assessment tailored to your specific
                        needs.
                      </p>
                    </div>
                  )}
      ...
      <section className='py-20 bg-primary-blue text-white'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl text-gray-200 mb-8'>
            Be part of the solution. Switch to renewable energy and help us
            create a sustainable future for Nigeria.
          </p>
