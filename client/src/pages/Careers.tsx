  ...
  const openPositions = [
    {
      ...
      experience: '5+ years',
      description:
        'Lead solar system design and installation projects for residential and commercial clients.',
      responsibilities: [
    ...
    },
    {
      ...
      experience: '3+ years',
      description:
        'Drive sales growth by building relationships with residential and commercial clients.',
      responsibilities: [
    ...
    },
    {
      ...
      experience: '2+ years',
      description:
        'Install and maintain electrical systems for solar and hybrid power solutions.',
      responsibilities: [
                ...
                <Card className='h-fit'>
                  <CardHeader>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      ...
                      >
                        {
                          openPositions.find(job => job.id === selectedJob)
                            ?.type
                        }
                      </Badge>
